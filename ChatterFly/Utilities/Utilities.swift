...
public struct Utilities {
    ...
    private static var currentScreen: UIScreen {
        ...
        return UIScreen.main // fallback if no window found
    }
    ...
    public static var isSmallerVerticalHeight: Bool {
        let height = isLandscape ? currentScreen.bounds.width : currentScreen.bounds.height
        return height < 800
    }
